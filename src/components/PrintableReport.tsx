    ...
    <>
        ...
        <div className="bg-surface rounded-[var(--radius-lg)] border border-border w-full max-w-md shadow-xl">
          ...
          <div className="px-5 py-4">
            ...
            <div className="flex gap-3">
              <button type="button" className="flex-1 font-heading text-sm font-semibold py-2.5 px-5 rounded-[var(--radius-md)] bg-primary text-white cursor-pointer border-none hover:bg-primary-dark transition-colors duration-150" onClick={() => window.print()}>
                Print / Save as PDF
              </button>
              <button type="button" className="text-sm font-semibold py-2.5 px-5 rounded-[var(--radius-md)] border border-border bg-background text-text cursor-pointer hover:bg-hover-bg transition-colors duration-150" onClick={onClose}>
                Cancel
              </button>
            </div>
          </div>
      ...
      <div className="print-only">
        ...
        <div className="print-report" style={{ fontFamily: 'system-ui, sans-serif', maxWidth: '800px', margin: '0 auto', color: '#111' }}>
          ...
          <div style={{ textAlign: 'center', fontSize: '0.75rem', color: '#94A3B8', borderTop: '1px solid #E2E8F0', paddingTop: '0.75rem' }}>
